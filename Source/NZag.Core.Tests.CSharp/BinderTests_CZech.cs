...
LABEL 00
    ...
    quit";
            TestBinder(CZech, 0x7DC, expected);
        }
        #endregion
        #region Czech_7E4
        #region ZCode
...
LABEL 05
    return: 1";
            TestBinder(CZech, 0x7E4, expected);
        }
        #endregion
        #region Czech_8F4
        #region ZCode
...
LABEL 03
    ...
    return: 1";
            TestBinder(CZech, 0x8F4, expected);
        }
        #endregion
        #region Czech_AA4
        #region ZCode
...
LABEL 05
    ...
    discard: call 8e0 ()
    return: 1";
            TestBinder(CZech, 0xAA4, expected);
        }
        #endregion
        #region Czech_1150
        #region ZCode
...
LABEL 02
    ...
    return: 1";
            TestBinder(CZech, 0x1150, expected);
        }
        #endregion
        #region Czech_13A4
        #region ZCode
...
LABEL 05
    ...
    return: 1";
            TestBinder(CZech, 0x13A4, expected);
        }
        #endregion
        #region Czech_1640
        #region ZCode
...
LABEL 00
    write-word(4fa) <- 03
    return: 05";
            TestBinder(CZech, 0x1640, expected);
        }
        #endregion
        #region Czech_1AC8
        #region ZCode
...
LABEL 07
    ...
    return: 1";
            TestBinder(CZech, 0x1AC8, expected);
        }
        #endregion
        #region Czech_1B34
        #region ZCode
...
LABEL 15e
    ...
    return: 0";
            ...
            TestBinder(CZech, 0x1B34, expected);
        }
        #endregion
        #region Czech_2448
        #region ZCode
...
LABEL 02
    ...
    quit";
            TestBinder(CZech, 0x2448, expected);
        }
        #endregion
    }
}
